...
<template>
  <div class="px-xs py-md flex justify-center items-center min-h-[75vh]">
    <div class="p-md md:px-lg md:py-xl bg-dark-4 rounded-md drop-shadow-md">
        ...
        <div class="text-light-3">
          ...
          <div class="flex items-center justify-center gap-xs">
            ...
            <a
              ...
              target="_self"
              class="p-3xs rounded-md bg-light-1 text-dark-4 hover:bg-opacity-75 transition-colors duration-300 ease-linear"
