...
import ManguitoPicture from '@/assets/img/profile/manguito_small.jpg'
...
const setEmailAddress = computed<string>(() => {
...
<template>
  <div
    class="relative bg-dark-2 rounded-lg flex flex-col items-center justify-center pb-md pt-20 mt-3xl mb-md mx-2xs md:mx-sm"
  >
    <img
      :src="imageUrl"
    ...
    <div
      class="flex gap-4 items-center justify-center bg-dark-2 rounded-lg p-2xs"
    >
      <a
        :href="githubUrl"
        target="_blank"
